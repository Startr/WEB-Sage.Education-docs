...
- **Functions** extend the capabilities of the Sage WebUI itself, enabling you to add new AI model support (like Anthropic or Vertex AI) or improve usability (like creating custom buttons or filters).
...
While **tools** are used by the AI during a conversation, **functions** help extend or customize the capabilities of Sage WebUI itself. Imagine tools are like adding new ingredients to a dish, and functions are the process you use to control the kitchen! 🚪

#### Let's break that down: 

- **Functions** give you the ability to tweak or add **features** inside **Sage WebUI** itself.
...
Without functions, these would all be out of reach. But with this framework in Sage WebUI, you can easily extend these features!
