...
- [http://localhost:3000](http://localhost:3000) to access Sage WebUI.
...
If you're using Sage WebUI with Ollama, be sure to check out our [Starting with Ollama Guide](/getting-started/quick-start/starting-with-ollama) to learn how to manage your Ollama instances with Sage WebUI.

## Join the Community

Need help? Have questions? Join our community:

- [Sage WebUI Discord](https://discord.gg/5rJgQTnV4s)
